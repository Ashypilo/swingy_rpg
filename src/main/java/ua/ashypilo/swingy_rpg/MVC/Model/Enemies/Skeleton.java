...
import ua.ashypilo.swingy_rpg.MVC.Model.MyImages.ImagesSkeleton;

import javax.swing.*;

public class Skeleton extends Enemies {

    public Skeleton(JLayeredPane layers, int level) {
        super.layers = layers;
        super.classEnemies = "Skeleton";
        super.attack = 60 + (level * 10);
        super.defense = 40 + (level * 10);
        super.hitPoints = 30 + (level * 10);
    }
    ...
    public void Images() {
        switch (super.level) {
            case 1: {
                super.images = new ImagesSkeleton.Level1();
                break;
            }
            case 2: {
                super.images = new ImagesSkeleton.Level2();
                break;
            }
            case 3: {
                super.images = new ImagesSkeleton.Level3();
                break;
            }
            case 4: {
                super.images = new ImagesSkeleton.Level4();
                break;
            }
            case 5: {
                super.images = new ImagesSkeleton.Level5();
                break;
            }
            case 6: {
                super.images = new ImagesSkeleton.Level6();
                break;
            }
            case 7: {
                super.images = new ImagesSkeleton.Level7();
                break;
            }
        }
    }
